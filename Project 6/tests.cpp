...
/// @brief A simple baseline testing file to easily write tests in
///        that either test object creation or use or individual functions.
...
int main()
{
    // Test your object usage and their respective member functions!
